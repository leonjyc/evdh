 ...
 * version 0.1.2.0 test201502041932 (public win version) 
...
function merge_video(info, callback) {	// finish callback(exit_code);
	// in win version, now does not support auto merge video
	time_log('WARNING: this version of evdh is \'win\' version, now does not support auto merge video ! ');
	callback(-1);
	return;
